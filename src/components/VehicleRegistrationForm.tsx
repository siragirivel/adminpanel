          ...
          <form onSubmit={onSubmit}>
            ...
            <div className={styles.section}>
              ...
              <div className={`${styles.fieldGrid} ${styles.cols2}`}>
                ...
                <div className={styles.field}>
                  <label className={styles.label}>
                    {editingId ? "ODO reading update (km)" : "ODO reading (km)"}{" "}
                    {editingId ? (
                  ...
                  <input
                    ...
                    onChange={(event) =>
                      onFieldChange("odometer_km", event.target.value)
                    }
                    placeholder="e.g. 45210"
                  />
                  {editingId && existingOdometerKm ? (
                    <div className={styles.fieldHint}>
                      Current saved reading: {existingOdometerKm} km
                    </div>
                  ) : null}
                </div>
          ...
          <div className={styles.previewCard}>
            ...
            <div className={styles.previewBody}>
              {[
                ...
                ["ODO", formData.odometer_km ? `${formData.odometer_km} km` : ""],
