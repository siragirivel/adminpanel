...
export function QuotationViewer({ quotationId }: { quotationId: string }) {
  ...
  const odometerReading = extractOdometerReading(
    quotation.note || "",
    quotation.odometer_km ?? quotationVehicle.odometer_km,
  );
            ...
            <button
              ...
              onClick={() =>
                generateQuotationPDF({
                  ...
                  odometer_km: quotation.odometer_km ?? odometerReading,
                  note: quotation.note || "",
          ...
          <div className="mx-auto max-w-[820px] rounded-[24px] border border-slate-200 bg-white p-10 shadow-sm">
            ...
            <div className="mt-8 border-t border-slate-200 pt-6">
              ...
              <div className="mt-4 flex items-center justify-between gap-6 text-sm text-slate-500">
                ...
                <div>Valid from {format(new Date(quotation.start_date), "dd MMM yyyy")}</div>
              </div>
            </div>
